...
<div class="card">
    <div class="card-header" align="center">My Time-Table</div>
    <div class="card-body">
        <div class="row"> 
            <div class="col-md-4 mr-auto">
                <button data-target="#createtimetable" data-toggle="modal" class="btn btn-primary link">Create Timetable</button>
