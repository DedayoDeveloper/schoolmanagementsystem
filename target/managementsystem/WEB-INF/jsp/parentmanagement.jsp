                ...
                <form action="searchparentforadmin" method="post">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-primary btn-sm" id = "searchparentforadmin" type="submit">Search</button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <tbody>
                    <c:forEach items="${getAllParentUsers}" var = "getAllParentUsers" varStatus="status">
                        <tr>
                            ...
                            <td>${getAllParentUsers.emergencycontact}</td>
                            <td>${getAllParentUsers.phonenumber}</td>
                            <td><a class="btn btn-primary link" href="viewchildren/${getAllParentUsers.firstname}/${getAllParentUsers.lastname}/${getAllParentUsers.username}/${getAllParentUsers.email}">View Children</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
