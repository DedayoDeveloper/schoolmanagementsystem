<%-- 
    Document   : newlanding
    Created on : Nov 2, 2019, 9:27:17 AM
    Author     : oreoluwa
--%>
...
<html>
	...
	<!-- Icomoon Icon Fonts-->
        <link rel="stylesheet" href="<spring:url value="/resources/css/icomoon.css"/>">
	<!-- Bootstrap  -->
        <link rel="stylesheet" href="<spring:url value="/resources/css/bootstrap.css"/>">

	<!-- Magnific Popup -->
        <link rel="stylesheet" href="<spring:url value="/resources/css/magnific-popup.css"/>">

	<!-- Owl Carousel  -->
        <link rel="stylesheet" href="<spring:url value="/resources/css/owl.carousel.min.css"/>">
        <link rel="stylesheet" href="<spring:url value="/resources/css/owl.theme.default.min.css"/>">

	<!-- Flexslider  -->
        <link rel="stylesheet" href="<spring:url value="/resources/css/flexslider.css"/>">

	<!-- Pricing -->
        <link rel="stylesheet" href="<spring:url value="/resources/css/pricing.css"/>">

	<!-- Theme style  -->
        <!--<link rel="stylesheet" href="<spring:url value="/resources/css/styletemplate.css"/>">-->
