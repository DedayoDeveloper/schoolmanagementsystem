...
<!--                                     <li class="list-group-item"><a href="<c:url value="/logout" />" data-toggle="tooltip" title="done with using the channel, you can log out">logout</a></li>-->
                    ...
                    <div id="mySidenav" class="sidenav gradient sn-bg-1">
       ...
       <div class="">                 
                    ...
                    <ul class="">
                        <c:forEach items="${role}" var = "role" varStatus="status">
                            <li class="" ><a class="link" href="${role.urlmapping}" data-toggle="tooltip" title="${role.labeltitle}" style="  font-size: 15px;">${role.labelicon} ${role.label}</a></li>
                            </c:forEach>
                        <li class=""><a href="<c:url value="/logout" />" data-toggle="tooltip" title="done with using the channel, you can log out"><i class="fa fa-lock" aria-hidden="true"></i> logout</a></li>
                    </ul>
